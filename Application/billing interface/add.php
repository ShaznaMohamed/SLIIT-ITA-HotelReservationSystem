	...
	<html>
		...
		<body>
			...
			<form method="post" action="option.html">
				...
				<select> <option> <a href="uma.html"> Room </a> </option>
						 <option> <a href="newwed.html"> Wedding  </a> </option>
						  <option> <a href="M
						  	eeting&Events.html"> Event </a> </option>
						 <option> <a href="uma.html"> Spa </a> </option>
						 <option> <a href="sanjaya.html"> Pool </a> </option>
						 <option> <a href="uma.html"> Gym </a> </option>
				</select>
				<br>
				<br>
				<br>

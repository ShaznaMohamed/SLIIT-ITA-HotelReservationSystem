...
<body  bgcolor="#E4DCBB"> 
	<center> 
		<h2 style="font-family: calibri; color: #A0522D">Petite Lux Suite</h2> 
		<table border="1" style="font-family: calibri"> 
			<tr> <th> Number of Total Rooms </th> 
...
<?php
	$selectString="SELECT * FROM adminroom WHERE name like 'Petite Lux Suite'";
